import { formatJavaSourceCode } from "./codeFormatter.js";
import { JavaKeyword, JavascriptKeyword, AngularKeywords, TypescriptKeyword, cSharpKeywords, AspNetClassicKeywords, AspNetMvcCore, AspNetMvcKeywords }from "./keywords.js";

const JavaSource = `package com.voipplus.mmsclient.randomData;
...
const result = formatJavaSourceCode(JavaSource, JavaKeyword);
